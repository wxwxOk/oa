...
- [x] **Phase 13: PDF 保真输出** - print 模式 table 转换 + 智能分页 + 页眉页脚 + 中文字体栈 (completed 2026-04-22)
...
- [x] 13-02-PLAN.md — 分页算法纯函数 TDD 测试（Wave 0）
- [x] 13-03-PLAN.md — usePdfExport.ts 重写（智能分页 + 页眉页脚 + 表头复出）+ 视觉验收
...
Plans:
- [x] 14-01-PLAN.md — PC 960px 容器 + 移动端单列 CSS + sticky 提交按钮
- [ ] 14-02-PLAN.md — 动态表格移动端卡片布局 (QExpansionItem) + 视觉验收
**UI hint**: yes
...
| 14. 响应式填写页 | v1.2 | 1/2 | In Progress|  |
