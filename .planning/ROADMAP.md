...
- 🚧 **v1.3 到访信息管理** — Phases 20-23 (planned)
...
- [ ] **Phase 20: 到访数据模型 + 后端 API** (3 plans) — VisitRecord 模型、权限种子、CRUD/筛选/统计/导入端点骨架
- [ ] **Phase 21: 到访管理页面 + CRUD 筛选** (3 plans) — 独立菜单、PC 表格、移动卡片、新建/编辑/详情、筛选项
- [ ] **Phase 22: Excel 导入解析 + 预览入库** (2 plans) — SheetJS 解析第 2 行表头、导入预览、重复提醒、批量创建
- [ ] **Phase 23: 统计面板 + 转化汇总** (2 plans) — 渠道/人员/状态维度统计、日期筛选、图表和摘要卡片
...
| 20. 到访数据模型 + 后端 API | v1.3 | 0/3 | Planned | — |
| 21. 到访管理页面 + CRUD 筛选 | v1.3 | 0/3 | Planned | — |
| 22. Excel 导入解析 + 预览入库 | v1.3 | 0/2 | Planned | — |
| 23. 统计面板 + 转化汇总 | v1.3 | 0/2 | Planned | — |
