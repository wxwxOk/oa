...
- [ ] **Phase 16: 流程配置与模板绑定** - 审批模式、单步/串行流程配置、部门负责人、RBAC 和动态必填/schema 版本 (verification gap found 2026-04-25)
...
**Verification:** gaps_found — full process edit can disable a process bound by published `APPROVAL_REQUIRED` templates; see `16-VERIFICATION.md`
Plans:
...
| 16. 流程配置与模板绑定 | v2.0 | 8/8 | Gap Closure Required |  |
