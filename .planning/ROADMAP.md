...
**Plans:** 4 plans
Plans:
- [ ] 12-01-PLAN.md — Schema ID 修复 + store 选中泛化 + fieldRegistry 结构项
- [ ] 12-02-PLAN.md — DesignerRowEditor 抽取 + DesignerCanvas 重写 + FieldPalette 结构组
- [ ] 12-03-PLAN.md — PropertyEditor 分组/动态表格属性编辑分支
