...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'review/channel-push', component: () => import('pages/ChannelPushReviewPage.vue'), meta: { title: '待我审核', icon: 'fact_check', permAny: ['channelPush:review', 'channelPush:viewScope'] } },
      { path: 'review/channel-push/:id', component: () => import('pages/ChannelPushReviewDetailPage.vue'), meta: { title: '推送审核详情', permAny: ['channelPush:review', 'channelPush:viewScope'] } },
